...
int Headunit::startHU(){
    ...
    int ret = headunit->hu_aap_start(true, true);
    logd("======> 2");
    if ( ret >= 0) {
...
int Headunit::stopHU(){
    ...
    if(headunit){
        ...
        headunit->hu_aap_shutdown();
        qDebug() << "--- app_shoutdown 1----";
        delete(headunit);
        qDebug() << "--- app_shoutdown 2----";
        headunit = NULL;
        qDebug() << "--- app_shoutdown 3----";
    }
#endif
    return 1;
}
int Headunit::restartHU(){
    ...
    qDebug() << "--- call hu_aap_shutdown----";
    //headunit->hu_aap_shutdown();
    //qDebug() << "--- call hu_aap_start----";
    //headunit->hu_aap_start(true, true);
    if(headunit){
        qDebug() << "Stopping headunit";
        headunit->hu_aap_shutdown();
        qDebug() << "--- app_shoutdown 1----";
